    ...
    <>
      <div className="navbar bg-base-100">
        ...
        <div className="navbar-end  pr-5">
         ...
         <a className="indicator"  href="https://github.com/aryan-257">
            <svg
          ...
          <button className="btn btn-ghost btn-circle">
            <a className="indicator" href="https://www.linkedin.com/in/aryan-dalal-?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="2em"
                viewBox="0 0 448 512"
